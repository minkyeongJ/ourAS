...
<html lang="en" class="h-100">
  ...
  <body class="d-flex h-100 text-white bg-dark">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <h1 style="text-align: center; margin-bottom: 30px;">회원가입(엔지니어)</h1>
      ...
      <div class="table2">
        <table style="margin-left:auto; margin-right:auto;">
          ...
          <tbody>
            ...
            <tr>
              <th style="padding-right:30px">범죄이력 첨부파일</th>
              <td class="text-left" style="padding: 10px;">
                <button type="submit" value="파일선택">파일선택</button><input type="text" name="md-file" style="width:345px;">
              </td>
            </tr>
          </tbody>
        </table> 
