...
<html lang="en" class="h-100">
  ...
  <body class="d-flex h-100 text-white bg-dark">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <h1 style="text-align: center; margin-bottom: 30px;">개인정보변경</h1>
        ...
        <table style="margin-left:auto; margin-right:auto;">
          ...
          <tbody>
            ...
            <!--  <div class="control-group warning">
            	<label for ="txtPass1" class="control-label">비밀번호</label>
            	<div class="controls">
            		<input type="password" id="txtPass1" class="input-medium"/>
            	</div> -->
            </div>
            ...
            <tr>
              <th style="padding-right:30px">변경된비밀번호</th>
              <td>
